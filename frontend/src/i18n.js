...
const resources = {
  en: {
    translation: {
      ...
      "khadameniDesc" : "A service marketplace connecting customers with local providers for easy service booking and management",
  ...
  fr: {
    translation: {
      ...
      "khadameniDesc" : "Une plateforme de services reliant les clients aux prestataires locaux pour une réservation et une gestion simplifiées.",
