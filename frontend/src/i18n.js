...
const resources = {
  en: {
    translation: {
      ...
      "khadameniDesc" : "A service marketplace connecting customers with providers for easy service booking",
  ...
  fr: {
    translation: {
      ...
      "khadameniDesc" : "Une plateforme de services reliant les clients aux prestataires pour une réservation.",
