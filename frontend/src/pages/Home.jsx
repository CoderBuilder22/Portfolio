      ...
      <section className="talents-section">
        ...
        <div className="talents-content">
          <div className="talent-category">
            <h3><i className="bi bi-database"></i> {t('databaseManagement')}</h3>
            <ul>
              <li><SiMysql className="tech-icon" /> MySQL</li>
              <li><SiMongodb className="tech-icon" /> MongoDB</li>
            </ul>
          </div>
          <div className="talent-category">
            <h3><i className="bi bi-gear"></i> {t('frameworks')}</h3>
            <ul>
              <li><SiReact className="tech-icon" /> React</li>
              <li><SiExpress className="tech-icon" /> Express.js</li>
            </ul>
          </div>
          <div className="talent-category">
            <h3><i className="bi bi-code"></i> {t('programmingLanguages')}</h3>
            <ul>
              <li><SiJavascript className="tech-icon" /> JavaScript</li>
              <li><SiPython className="tech-icon" /> Python</li>
